...
float4 NMLAYER( PS_INPUT input )
{
    return ((
#ifdef _CPUT
normal.Sample( SAMPLER0, (((input.UV0)) *(float2(30, 30).xyyy)) )
#else
...
float4 DMLAYER( PS_INPUT input )
{
    return 
#ifdef _CPUT
diffuse.Sample( SAMPLER0, (((input.UV0)) *(float2(30, 30).xyyy)) )
#else
Tex2D( SAMPLER0, (((input.UV0)) *(float2(30, 30).xyyy)) )
#endif
;
}
...
float4 SMLAYER( PS_INPUT input )
{
    return 
#ifdef _CPUT
specular.Sample( SAMPLER0, (((input.UV0)) *(float2(30, 30).xyyy)) )
#else
Tex2D( SAMPLER2, (((input.UV0)) *(float2(30, 30).xyyy)) )
#endif
;
}
